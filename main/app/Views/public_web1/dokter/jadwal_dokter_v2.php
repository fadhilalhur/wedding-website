<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&display=swap" rel="stylesheet"> <!-- Tambahan untuk font Roboto -->
<style>
    body {
        font-family: 'Roboto';
        /* Mengganti ke Roboto */
    ...
    .doctor-card {
        ...
        margin-bottom: 20px;
        display: block;
        /* Mengubah ke block untuk responsivitas */
        width: 90%;
    ...
    .doctor-card img {
        ...
        border-radius: 10px;
        margin-right: 0;
        /* Menghapus margin kanan pada mobile */
        display: block;
        /* Mengubah ke block pada mobile */
        margin-left: auto;
        margin-right: auto;
    }
    ...
    .doctor-card .schedule-table th {
        ...
        padding: 8px;
        text-align: center;
        border: 1px solid #f3f8ffff;
    }

    .doctor-card .schedule-table td {
        background-color: #f3f8ffff;
        color: #2d3748;
        padding: 8px;
        text-align: center;
        border: 1px solid #f3f8ffff;
    ...
    .doctor-card .schedule-table td.available {
        color: #4a5568;
    }
    ...
    @media (max-width: 768px) {
        ...
        .doctor-card .details {
            ...
            /* Menghapus float pada mobile */
            width: 100%;
            /* Memastikan detail mengisi lebar penuh */
        }
        ...
        .doctor-card .schedule-table {
            ...
            overflow-x: auto;
            /* Tetap sediakan scroll horizontal jika perlu */
        }
    }
            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col mb-3">
                    ...
                    <select id="doctorSelect" class="form-select" style="width: 200px;">
                        ...
                        <!-- Opsi dokter akan diisi oleh JavaScript -->
                    </select>
                </div>
                <div class="col mb-3">
                    ...
                    <select id="poliSelect" class="form-select" style="width: 200px;">
                        ...
                        <!-- Opsi poli akan diisi oleh JavaScript -->
                    </select>
                </div>
                <div class="col mb-3">
                    <label for="hariSelect" class="form-label">Hari:</label>
                    <div class="hari-filters">
                ...
                <div class="col-auto ms-auto"> <!-- Menggunakan ms-auto untuk menempatkan tombol ke kanan -->
                    <label for="searchBtnHeader" class="form-label">&nbsp;</label>
