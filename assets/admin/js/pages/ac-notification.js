...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelector('#btn-default-i').addEventListener('click', function () {
    notifier.show('Default!', 'I am a default notification.', '', base_url + 'assets/images/notification/clock-48.png', 0);
  });

  document.querySelector('#btn-info-i').addEventListener('click', function () {
    notifier.show('Reminder!', 'You have a meeting at 10:30 AM.', 'info', base_url + 'assets/images/notification/survey-48.png', 0);
  });

  document.querySelector('#btn-success-i').addEventListener('click', function () {
    notifier.show('Well Done!', 'You just submit your resume successfully.', 'success', base_url + 'assets/images/notification/ok-48.png', 0);
  });
  ...
  document.querySelector('#btn-warning-i').addEventListener('click', function () {
    notifier.show(
      ...
      'warning',
      base_url + 'assets/images/notification/medium_priority-48.png',
      0
    );
  });

  document.querySelector('#btn-danger-i').addEventListener('click', function () {
    notifier.show('Sorry!', 'Could not complete your transaction.', 'danger', base_url + 'assets/images/notification/high_priority-48.png', 0);
  });

  document.querySelector('#btn-default-ac').addEventListener('click', function () {
    notifier.show('Default!', 'I am a default notification.', '', base_url + 'assets/images/notification/clock-48.png', 4000);
  });

  document.querySelector('#btn-info-ac').addEventListener('click', function () {
    notifier.show('Reminder!', 'You have a meeting at 10:30 AM.', 'info', base_url + 'assets/images/notification/survey-48.png', 4000);
  });

  document.querySelector('#btn-success-ac').addEventListener('click', function () {
    notifier.show('Well Done!', 'You just submit your resume successfully.', 'success', base_url + 'assets/images/notification/ok-48.png', 4000);
  });
  ...
  document.querySelector('#btn-danger-ac').addEventListener('click', function () {
    notifier.show('Sorry!', 'Could not complete your transaction.', 'danger', base_url + 'assets/images/notification/high_priority-48.png', 4000);
  });
  ...
  var showNotification = function () {
    notificationId = notifier.show(
      ...
      'info',
      base_url + 'assets/images/notification/survey-48.png',
      4000
    );
  };
